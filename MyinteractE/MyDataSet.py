...
class My_Train_DataSet(Data.Dataset):
    def __init__(self, train_data, triples_label, train_label):
        super(My_Train_DataSet, self).__init__()
        self.train_data = train_data
        self.triples_label = triples_label
    ...
    def __getitem__(self, idx):
        return self.train_data[idx], self.triples_label[idx], self.train_label[idx]
